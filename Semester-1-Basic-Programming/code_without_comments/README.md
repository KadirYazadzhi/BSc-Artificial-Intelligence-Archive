...
*   **Sorting Algorithm:** The project utilizes a **hybrid sorting approach**. It uses **Quicksort** for smaller datasets (less than 50 properties) and **Merge Sort** for larger datasets, sorting properties by price. This ensures optimal performance across different data sizes.
...
### `src/sort.cpp`
*   **Purpose:** Entry point for sorting operations.
*   **Functions:**
    *   `sortPropertiesArray()`: Determines whether to use Quicksort or Merge Sort based on array size and initiates the sorting process.

### `src/sorting-algorithms/quickSort.cpp`
*   **Purpose:** Implements the Quicksort algorithm for efficient in-place sorting of smaller datasets.
*   **Functions:**
    *   `quickSort()`, `partition()`, `swap()`: The core components of the Quicksort algorithm.

### `src/sorting-algorithms/mergeSort.cpp`
*   **Purpose:** Implements the Merge Sort algorithm for stable sorting of larger datasets.
*   **Functions:**
    *   `mergeSort()`, `merge()`: The core components of the Merge Sort algorithm.
...
| `src/update.cpp` | 231 |
| `src/utils.cpp` | 131 |
| `src/sorting-algorithms/mergeSort.cpp` | 93 |
| `src/sorting-algorithms/quickSort.cpp` | 84 |
| `include/add.h` | 94 |
| `include/colors.h` | 17 |
| `include/delete.h` | 33 |
| `include/display.h` | 62 |
| `include/file.h` | 94 |
| `include/localization.h` | 62 |
| `include/menu.h` | 88 |
| `include/reports.h` | 41 |
| `include/search.h` | 33 |
| `include/sort.h` | 79 |
| `include/structs.h` | 48 |
| `include/update.h` | 101 |
| `include/utils.h` | 56 |